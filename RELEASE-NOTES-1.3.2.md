...
The manager's 20 unit tests pass on Python 3.10 and 3.12, including new tests for finding the game and MLLoader and for installing with and without MLLoader. The main window was driven headlessly through first-run game detection and both setup paths. Not yet run on Windows.
