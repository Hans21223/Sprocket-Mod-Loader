...
namespace Il2CppInterop.Runtime.Injection
{
    internal static unsafe class InjectorHelpers
    {
        ...
        private static readonly SprocketGenericMethodHook SprocketGenericHook = new();
        ...
        internal static void Setup()
        {
            ...
            if (SprocketUnity6Profile.Active)
                SprocketGenericHook.ApplyHook();
            else if (Il2CppInteropRuntime.Instance.UnityVersion.Major >= 6000)
